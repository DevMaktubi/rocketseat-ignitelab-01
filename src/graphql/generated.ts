...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', title: string, slug: string, id: string, availableAt?: any | null, lessonType: LessonType }> };
